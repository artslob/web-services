...
package ifmo.artslob.webservices.lab3.client.generated;
 ...
 * generated in the ifmo.artslob.webservices.lab3.client.generated package. 
...
public class ObjectFactory {
    ...
    private final static QName _CreateCityResponse_QNAME = new QName("http://lab3.webservices.artslob.ifmo/", "createCityResponse");
    private final static QName _UpdateCity_QNAME = new QName("http://lab3.webservices.artslob.ifmo/", "updateCity");
    private final static QName _CreateCity_QNAME = new QName("http://lab3.webservices.artslob.ifmo/", "createCity");
    private final static QName _DeleteCity_QNAME = new QName("http://lab3.webservices.artslob.ifmo/", "deleteCity");
    private final static QName _UpdateCityResponse_QNAME = new QName("http://lab3.webservices.artslob.ifmo/", "updateCityResponse");
    private final static QName _DeleteCityResponse_QNAME = new QName("http://lab3.webservices.artslob.ifmo/", "deleteCityResponse");
    private final static QName _GetCitiesResponse_QNAME = new QName("http://lab3.webservices.artslob.ifmo/", "getCitiesResponse");
    private final static QName _GetCities_QNAME = new QName("http://lab3.webservices.artslob.ifmo/", "getCities");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ifmo.artslob.webservices.lab3.client.generated
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab3.webservices.artslob.ifmo/", name = "createCityResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab3.webservices.artslob.ifmo/", name = "updateCity")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab3.webservices.artslob.ifmo/", name = "createCity")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab3.webservices.artslob.ifmo/", name = "updateCityResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab3.webservices.artslob.ifmo/", name = "deleteCityResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab3.webservices.artslob.ifmo/", name = "getCitiesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab3.webservices.artslob.ifmo/", name = "getCities")
