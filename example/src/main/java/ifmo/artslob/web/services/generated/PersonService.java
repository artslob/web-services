 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://services.web.artslob.ifmo/", wsdlLocation = "http://0.0.0.0:8080/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://services.web.artslob.ifmo/", "PersonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://0.0.0.0:8080/PersonService?wsdl");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://services.web.artslob.ifmo/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.web.artslob.ifmo/", "PersonWebServicePort"), PersonWebService.class, features);
    }
