 ...
 * generated in the ifmo.artslob.web.services.generated package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetPersons_QNAME = new QName("http://services.web.artslob.ifmo/", "getPersons");
    private final static QName _GetPersonsResponse_QNAME = new QName("http://services.web.artslob.ifmo/", "getPersonsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ifmo.artslob.web.services.generated
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.web.artslob.ifmo/", name = "getPersons")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.web.artslob.ifmo/", name = "getPersonsResponse")
