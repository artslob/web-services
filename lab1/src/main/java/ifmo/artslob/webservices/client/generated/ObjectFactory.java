...
package ifmo.artslob.webservices.client.generated;
 ...
 * generated in the ifmo.artslob.webservices.client.generated package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetCitiesResponse_QNAME = new QName("http://webservices.artslob.ifmo/", "getCitiesResponse");
    private final static QName _GetCities_QNAME = new QName("http://webservices.artslob.ifmo/", "getCities");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ifmo.artslob.webservices.client.generated
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices.artslob.ifmo/", name = "getCitiesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices.artslob.ifmo/", name = "getCities")
