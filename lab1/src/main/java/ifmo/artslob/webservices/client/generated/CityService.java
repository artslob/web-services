 ...
 * 
 */
@WebServiceClient(name = "CityService", targetNamespace = "http://webservices.artslob.ifmo/", wsdlLocation = "http://0.0.0.0:8080/CityService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CITYSERVICE_QNAME = new QName("http://webservices.artslob.ifmo/", "CityService");
    ...
    public CityWebService getCityWebServicePort() {
        return super.getPort(new QName("http://webservices.artslob.ifmo/", "CityWebServicePort"), CityWebService.class);
    }
    ...
    public CityWebService getCityWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.artslob.ifmo/", "CityWebServicePort"), CityWebService.class, features);
    }
